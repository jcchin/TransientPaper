...
both tools must follow the same object-oriented nature. \cite{MatlabOOP}
...
A NPSS developer could also include special attributes within standard components that would be
ignored by NPSS, but parsed by the SST transcompiler to provide additional context.
